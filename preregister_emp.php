  ...
  <body>
    ...
    <div class="text-center">
      ...
      <form style="max-width:480px;margin:auto;">
        ...
        <input type="text" name="f_name" id="pname" class="form-control mb-3" placeholder="First name" required>
        <input type="text" name="l_name" id="pname" class="form-control mb-3" placeholder="Last name" required>
        ...
        <input type="text" name="emp_id" id="pname" class="form-control mb-3" placeholder="Employee id" required>
        <input type="text" name="dept_id" id="pname" class="form-control mb-3" placeholder="Department id" required>
