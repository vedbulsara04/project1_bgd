  ...
  <body>
    <div class="text-center">
      <form action="insert_register.php" method="POST"style="max-width:480px;margin:auto;">
        ...
        <input type="text" id="username" name="username" class="form-control mb-3" placeholder=" Enter Name" required>
        <input type="email" id="emailAddress" name="email" class="form-control mb-3" placeholder="Enter Email" required>
        <input type="tel" id="phone" name="pnumber" class="form-control mb-3" placeholder="Enter Phone No" pattern="[0-9]{10}" required>
        <div class="input-group mb-3">
          <input name="password" type="password" value="" class="input form-control" id="password" name="password" placeholder="Enter Password" required="true" aria-label="password" aria-describedby="basic-addon1" required />
        ...
        <div class="input-group mb-3">
          <input name="Cpassword" type="password" value="" class="input form-control" id="Cpassword" placeholder="Confirm Password" required="true" aria-label="password" aria-describedby="basic-addon1" required />
          <div class="input-group-append">
        ...
        <div class="d-grid mt-4">
          <input type="submit"  value="Register" name="register" class="btn btn-primary btn-block" onClick="matchPassword();">
        </div>
      </form>
    </div>
  </body>
